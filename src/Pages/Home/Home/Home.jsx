...
const Home = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="mt-[-580px] lg:mt-0 md:mt-[-600px] pb-16 lg:pb-0 lg:grid  grid-cols-12 flex flex-col-reverse lg:justify-between items-center h-[100%] max-w-[90%] mx-auto">
