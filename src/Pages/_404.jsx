...
const NotFound = () => {
  return (
      <div className="h-screen w-screen bg-gray-100 overflow-x-hidden overflow-y-hidden relative">
          <div className="w-4/5 mx-auto flex flex-col-reverse md:flex-row flex-nowrap items-center justify-between gap-6 px-5 text-gray-700 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
          ...
          >
            <defs>
              <style>
                ...
                {"{stroke-width:3px;}"}.cls-2{"{fill:#020202;}"}
                .cls-10,.cls-12,.cls-15,.cls-17,.cls-2,.cls-3,.cls-4,.cls-5,.cls-6,.cls-7,.cls-9
                {"{stroke-miterlimit:10;}"}.cls-3{"{fill:#818181;}"}
                .cls-12,.cls-16,.cls-3,.cls-7,.cls-8,.cls-9
                {"{stroke:#191818;}"}.cls-4{"{fill:#dcdbda;}"}.cls-5
                {"{fill:#4ea7f1;}"}.cls-14,.cls-6{"{fill:#f8f3ed;}"}
                .cls-16,.cls-7{"{fill:#333;}"}.cls-13,.cls-8
                {"{fill:none;}"}.cls-9{"{fill:#f8f59c;}"}.cls-10,.cls-11
                {"{fill:#f3d2c9;}"}.cls-15{"{fill:#8bb174;}"}.cls-17
                {"{fill:#da4e22;}"}
              </style>
            </defs>
